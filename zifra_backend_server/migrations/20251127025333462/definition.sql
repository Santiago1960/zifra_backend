...
CREATE TABLE "invoice_detail" (
    ...
    "_invoicesDetallesInvoicesId" bigint
);
...
ALTER TABLE ONLY "invoice_detail"
    ...
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "invoice_detail"
    ADD CONSTRAINT "invoice_detail_fk_1"
    FOREIGN KEY("_invoicesDetallesInvoicesId")
    REFERENCES "invoices"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('zifra_backend', '20251127025333462', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20251127025333462', "timestamp" = now();
