...
import 'package:zifra_backend_server/src/generated/category.dart' as _i4;
...
class _InvoicesEndpoint {
  ...
  _i3.Future<List<_i6.Invoices>> getOpenProjectInvoices(
    _i1.TestSessionBuilder sessionBuilder,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'invoices',
        method: 'getOpenProjectInvoices',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'invoices',
          methodName: 'getOpenProjectInvoices',
          parameters:
        ...
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
          _localCallContext.arguments,
        ) as _i3.Future<List<_i6.Invoices>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<String> saveInvoices(
    _i1.TestSessionBuilder sessionBuilder,
    List<_i6.Invoices> invoices,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'invoices',
          methodName: 'saveInvoices',
          parameters: _i1.testObjectToJson({'invoices': invoices}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
  ...
  _i3.Future<List<_i6.Invoices>> getProjectInvoices(
    _i1.TestSessionBuilder sessionBuilder,
    int projectId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'invoices',
        method: 'getProjectInvoices',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'invoices',
          methodName: 'getProjectInvoices',
  ...
  _i3.Future<String> createProjectWithInvoices(
    _i1.TestSessionBuilder sessionBuilder,
    _i7.Projects project,
    List<_i6.Invoices> invoices,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'invoices',
        method: 'createProjectWithInvoices',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'invoices',
          methodName: 'createProjectWithInvoices',
  ...
  _i3.Future<_i6.Invoices?> updateInvoiceCategory(
    _i1.TestSessionBuilder sessionBuilder,
    String claveAcceso,
    int? categoryId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'invoices',
        method: 'updateInvoiceCategory',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'invoices',
          methodName: 'updateInvoiceCategory',
          parameters: _i1.testObjectToJson({
...
class _ProjectsEndpoint {
  ...
  _i3.Future<List<_i7.Projects>> getClosedProjects(
    _i1.TestSessionBuilder sessionBuilder, {
    String? rucBeneficiario,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'projects',
        method: 'getClosedProjects',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'projects',
          methodName: 'getClosedProjects',
          parameters:
              _i1.testObjectToJson({'rucBeneficiario': rucBeneficiario}),
          serializationManager: _serializationManager,
        );
